...
!function (e) {
    ...
    r.prototype.createAreaChart = function (e, r, o, a, t, n, i, l) {
        ...
        ChartColorChange(Morris.Donut({element: e, data: r, resize: !0, colors: o}), "morris-donut-example")
        ...
        e && this.createAreaChart("morris-area-example", 0, 0, [{y: "2011", a: 0, b: 0, c: 0}, {
            y: "2012",
            a: 150,
            b: 45,
            c: 15
        ...
        r && this.createDonutChart("morris-donut-example", [{
            ...
            value: 12
        }, {label: "In-Store Sales", value: 30}, {label: "Mail-Order Sales", value: 20}], r);
        var o = getChartColorsArray("morris-bar-stacked");
        o && this.createStackedChart("morris-bar-stacked", [{y: "2005", a: 45, b: 180}, {
            y: "2006",
            a: 75,
            b: 65
            ...
            a: 75,
            b: 65
        }, {y: "2015", a: 100, b: 90}, {y: "2016", a: 80, b: 65}], "y", ["a", "b"], ["Series A", "Series B"], o)
