                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="p-3">
                            ...
                            <form enctype="multipart/form-data"
                                  method="post" class="form-horizontal mt-4"
                                  action="<?= base_url() ?>kontroluye">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="tipi">Kullanıcı türü seçiniz</label>
                                    <select class="form-select" name="tipi" id="tipi">
                                ...
                                <div class="mb-3" id="belgeDiv">
                                    <label for="belge">Öğrenci belgesi/kimliği</label>
                                    <input type="file"
                                           class="form-control rounded-pill"
                                           id="belge" name="belge"
                                           placeholder="Öğrenci belgesi/kimliği seçin">
                                </div>

                                <div class="row mt-4">
                                    <div class="col-12 text-center">
                                        <button id="uye-ol-button"
                                           class="fw-bold btn btn-danger w-md waves-effect waves-light w-100 rounded-pill mb-2"
                                           type="submit">Üye Ol</button>
                                        <a href="<?= base_url() ?>"
                                           class="fw-bold btn btn-primary w-md waves-effect waves-light w-100 rounded-pill"
                                                type="submit">Zaten üye misiniz? <i class="mdi mdi-transfer-right"></i> Giriş</a>
...
<script>
    $(document).ready(function() {
        $('#belgeDiv').addClass('d-none');
        $("#uye-ol-button").attr('disabled', true);

        $("#tipi").on("change", function() {
            var selectedOption = $(this).val();
            if (selectedOption === 'Öğrenci'){
                $("#uye-ol-button").attr('disabled', false);
                $('#belgeDiv').removeClass('d-none');
